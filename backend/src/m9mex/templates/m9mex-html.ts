...
export function generateM9MexHtml(data: M9Mex): string {
...
<head>
  <style>
    ...
    .container { width: 100%; border: 2px solid black; padding: 5px; }
    ...
    .input { border-bottom: 1px solid black; display: inline-block; padding: 0 5px; }
...
<div class="container">
  ...
  <!-- USER INFO -->
  <div class="section">
    <div class="row"><span class="label" style="width: 80px;">USUARIO:</span> <span class="input" style="width: 600px;">${val(data.usuario)}</span></div>
    <div class="row"><span class="label" style="width: 80px;">DOMICILIO:</span> <span class="input" style="width: 600px;">${val(data.domicilio)}</span></div>
    <div class="row"><span class="label" style="width: 80px;">OBSERVACIONES:</span> <span class="input" style="width: 600px;">${val(data.observaciones)}</span></div>
  </div>
  ...
  <div class="section">
    <div class="row">
      ...
      <span class="label" style="margin-left: 10px;">MARCA:</span> <span class="input" style="width: 100px;">${val(data.marcaMedidor)}</span> <!-- Usually brand of Transf? reused -->
      <span class="label" style="margin-left: 10px;">DEM. CONT.:</span> <span class="input" style="width: 50px;">${val(data.demCont)}</span>
      <span class="label">KW'S</span>
    </div>
    <div class="row">
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>${val(data.noCfe)}</td> <td>${val(data.inst_kw)}</td> <!-- Logic check: usually separate fields? -->
        <td>${val(data.ret_kwh)}</td> <td>${val(data.ret_kw)}</td> <!-- Using generic ret fields for row 1 context if applicable, or mapped specifically -->
        <td></td>
      </tr>
      <tr><td class="left">No. DE FABRICA</td> <td>${val(data.noFabrica)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">MARCA</td> <td>${val(data.marcaMedidor)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">TIPO</td> <td>${val(data.tipoMedidor)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">CÓDIGO DE MEDIDOR</td> <td>${val(data.codigoMedidor)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">CÓDIGO DE LOTE</td> <td>${val(data.codigoLote)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">FASE - ELEMENTOS</td> <td>${val(data.faseElementos)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">HILOS - CONEXIÓN</td> <td>${val(data.hilosConexion)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">AMPS (CLASE)</td> <td>${val(data.ampsClase)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">VOLTS</td> <td>${val(data.volts)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">Rr-Rs</td> <td>${val(data.rrRs)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">Kh-Kr</td> <td>${val(data.khKr)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">LECTURA</td> <td>${val(data.lectura)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">No. DE CARÁTULAS</td> <td>${val(data.noCaratulas)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">MULTIPLICADOR</td> <td>${val(data.multiplicador)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      <tr><td class="left">KW TIPO</td> <td>${val(data.kwTipo)}</td> <td></td> <td></td> <td></td> <td></td></tr>
      ...
      <!-- DEMANDA -->
       ...
       <tr>
         ...
         <td>KWH</td> <td>KW</td> <td>KVARH</td> <td>MEC KWH</td>
       </tr>
       <tr>
